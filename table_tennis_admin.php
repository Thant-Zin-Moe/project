...
<head>
    ...
    <title>Table Tennis Admin Page</title>
    <link rel="stylesheet" href="css/admin.css">
</head>

<body>
    <div class="form">
        <form action="table_tennis_admin.php" method="post">
            <h2>Table Tennis Admin Page</h2>
            <h3>About Event</h3>
...
if (isset($_POST['send'])) {
    ...
    $email = "SELECT * FROM table_tennis WHERE email_send=1";
